...
# solve with QOCS
K = Cone(Kf,Kl,Kq,Ks)
settings = OSSDPSettings(max_iter=3000,verbose=false,checkTermination=1,checkInfeasibility=50,scaling = 10 ,scaleFunc=2,adaptive_rho=true,eps_abs=1e-6,eps_rel=1e-6)
